...
time.sleep (2)
print ("\t\x1b[91mSABAR BABI LAGI LOAD SC .....")
time.sleep (5)
os.system ("clear")
time.sleep (1)
print ("\x1b[91mNOTE !!!")
time.sleep (1)
print ("\x1b[92m[\x1b[91m1\x1b[92m] \x1b[92mSubribek Dulu Channelnya kawand \x1b[91m:V")
time.sleep (1)
os.system("xdg-open https://youtube.com/channel/UC683ha2G4DEX24BjigEs7_w")
time.sleep (8)
print ("\x1b[92m[\x1b[91m2\x1b[92m] \x1b[92mMAKASIH UDAH Subribek \x1b[91m:)")
time.sleep (1)
print ("\x1b[91m")
os.system ("clear")
time.sleep (1)
